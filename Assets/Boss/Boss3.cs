...
public class Boss3 : MonoBehaviour, IDamageable
{
    ...
    [Header("Flip")]
    public bool facePlayer = true;       // �ʿ��ϸ� �� �� �ְ�
    public bool flipWhenPlayerOnLeft = true; // �� ��������Ʈ �⺻ ���⿡ ���� ����
    ...
    public float reflectWindow = 5f;   // �ֱ� 5�� ������ �ݻ�
    public float healWindow = 1f;      // �ֱ� 1�� �������� ȸ��
